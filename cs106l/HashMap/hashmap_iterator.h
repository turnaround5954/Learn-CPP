...
class HashMapIterator {
   public:
    /*
     * This alias is very important. When dealing with const_iterator, the value_type is always
     * const, and that prevents the client from modifying the elements via a const_iterator. The
    ...
    /*
     * Friend declarations so the HashMap class this iterator is for can access the attributes of
     * its iterators. Also, to make conversions between iterator and const_iterator easy, we declare
     * the corresponding iterator and const_iterators as friends.
     */
    friend Map;
     ...
     * incremented). The postfix operator returns a copy of the original iterator, while the
     * iterator itself is incremented.
     *
     ...
     * functions. Here we are following the rule of zero. You should think about why that is
     * correct.
     */
